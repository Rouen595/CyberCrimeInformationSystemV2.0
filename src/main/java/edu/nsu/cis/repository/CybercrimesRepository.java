...
//    User findByEmailAddress(String emailAddress);
    ...
    @Transactional(readOnly = true)
    @Query("Select c1 from Cybercrimes c1 join Person p on c1.personID.id = p.id join Cybercrime c2 on c1.cybercrimeID.id = c2.id join Persontype pt on p.id = pt.id " +
